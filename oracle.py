...
semantic_oracle = distance = [[[0 for k in range(13)] for j in range(5)] for i in range(5)]
...
semantic_oracle[0][0][11] = 4   # Int y Int (EQUAL GREATER THAN)
semantic_oracle[0][0][12] = 4   # Int y Int (EQUAL LESS THAN)
...
semantic_oracle[1][0][11] = 4   # Float y Int (EQUAL GREATER THAN)
semantic_oracle[1][0][12] = 4   # Float y Int (EQUAL LESS THAN)
...
semantic_oracle[2][2][11] = -1  # Char y Char (EQUAL GREATER THAN)
semantic_oracle[2][2][12] = -1  # Char y Char (EQUAL LESS THAN)
...
semantic_oracle[2][0][11] = -1   # Char y Int (EQUAL GREATER THAN)
semantic_oracle[2][0][12] = -1   # Char y Int (EQUAL LESS THAN)
...
semantic_oracle[2][1][11] = -1  # Char y Float (EQUAL GREATER THAN)
semantic_oracle[2][1][12] = -1  # Char y Float (EQUAL LESS THAN)
...
semantic_oracle[0][2][11] = -1  # Int y Char (EQUAL GREATER THAN)
semantic_oracle[0][2][12] = -1  # Int y Char (EQUAL LESS THAN)
...
semantic_oracle[1][2][11] = -1   # Float y Char (EQUAL GREATER THAN)
semantic_oracle[1][2][12] = -1   # Float y Char (EQUAL LESS THAN)
...
semantic_oracle[4][4][11] = -1  # Bool y Bool (EQUAL GREATER THAN)
semantic_oracle[4][4][12] = -1  # Bool y Bool (EQUAL LESS THAN)
...
semantic_oracle[4][0][11] = -1  # Bool y Int (EQUAL GREATER THAN)
semantic_oracle[4][0][12] = -1  # Bool y Int (EQUAL LESS THAN)
...
semantic_oracle[4][1][11] = -1  # Bool y Float (EQUAL GREATER THAN)
semantic_oracle[4][1][12] = -1  # Bool y Float (EQUAL LESS THAN)
...
semantic_oracle[4][2][11] = -1  # Bool y Char (EQUAL GREATER THAN)
semantic_oracle[4][2][12] = -1  # Bool y Char (EQUAL LESS THAN)
...
semantic_oracle[0][4][11] = -1  # Int y Bool (EQUAL GREATER THAN)
semantic_oracle[0][4][12] = -1  # Int y Bool (EQUAL LESS THAN)
...
semantic_oracle[1][4][11] = -1  # Float y Bool (EQUAL GREATER THAN)
semantic_oracle[1][4][12] = -1  # Float y Bool (EQUAL LESS THAN)
...
semantic_oracle[2][4][11] = -1  # Char y Bool (EQUAL GREATER THAN)
semantic_oracle[2][4][12] = -1  # Char y Bool (EQUAL LESS THAN)
